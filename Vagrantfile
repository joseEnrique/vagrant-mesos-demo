...
Vagrant.configure("2") do |config|
  ...
  (1..num_instances).each do |i|
    ...
    config.vm.define vm_name do |host|
      ...
      host.vm.provision :shell, inline: "curl -L -o /opt/cni/bin/calico https://github.com/projectcalico/cni-plugin/releases/download/v1.6.0/calico"
      host.vm.provision :shell, inline: "curl -L -o /opt/cni/bin/calico-ipam https://github.com/projectcalico/cni-plugin/releases/download/v1.6.0/calico-ipam"
